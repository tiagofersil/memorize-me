...
app.config["CLOUD_NAME"] = os.getenv("CLOUD_NAME", "dxzpale6f")
app.config["API_KEY"] = os.getenv("API_KEY", "174769924936732")
app.config["API_SECRET"] = os.getenv("API_SECRET", "fYc6C6tN6fAmnYam6GBG1H-1CLY")
